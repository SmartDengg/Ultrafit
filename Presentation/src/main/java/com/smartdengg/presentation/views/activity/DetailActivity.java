...
public class DetailActivity extends BaseActivity {
    ...
    public static void navigateToActivity(
            @NonNull AppCompatActivity startingActivity,
    ...
    private void runEnterAnimation(Bundle bundle) {
        ...
        Picasso.with(DetailActivity.this).load(movieEntity.getMovieThumbUrl()).noFade().into(movieThumbIv, new Callback.EmptyCallback() {
            @Override
