 ...
 */
public class CityListAdapter extends RecyclerView.Adapter<CityListAdapter.ItemHolder> implements Observer<List<CityEntity>> {
    ...
    public class ItemHolder extends RecyclerView.ViewHolder {
        ...
        @Bind(R.id.city_item_name_tv) TextView nameTv;
